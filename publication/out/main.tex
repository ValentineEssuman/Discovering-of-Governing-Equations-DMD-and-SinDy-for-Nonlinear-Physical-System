...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        \begin{figure}[htb]
        \centering
            \subfloat[Frame 1]{\includegraphics[width=0.2\textwidth]{figures/Frame 1.png}}\hfill
            \subfloat[Frame 2]{\includegraphics[width=0.2\textwidth]{figures/Frame 2.png}}\hfill
            \subfloat[Frame 3]{\includegraphics[width=0.2\textwidth]{figures/Frame 3.png}}... \hfill ...
            \subfloat[Frame n]{\includegraphics[width=0.2\textwidth]{figures/Frame 4.png}}
    ...
    \section{Methodology}
        ...
        Three complementary metrics are reported:
            ...
            \newpage
            \section{\textbf{Mechanical Model and Coordinates}}
                    \begin{figure}[ht]
                        \centering
                ...
                \subsubsection{\textbf{Center of Mass Position (CM)}}
                    \begin{align}
...
\begin{figure*}[h]
    ...
    \subfloat[Long Stick Predictions]{
        \includegraphics[width=0.48\textwidth]{figures/long_sticks_timeseries_ablation_models.png}
        \label{fig:appendix_long_timeseries}
    }
    \hfill
    \subfloat[Short Stick Predictions]{
        \includegraphics[width=0.48\textwidth]{figures/short_stick_ablation_of_models.png}
        \label{fig:appendix_short_timeseries}
    }

    \vspace{1em} % Adjust vertical spacing as needed

    \subfloat[Long Stick Ablation Metrics]{
        \includegraphics[width=0.48\textwidth]{figures/long_abaltion_metrics.png}
        \label{fig:appendix_long_metrics}
    }
    \hfill
    \subfloat[Short Stick Ablation Metrics]{
        \includegraphics[width=0.48\textwidth]{figures/short_abaltion_metrics.png}
        \label{fig:appendix_short_metrics}
    }

    \caption{Top row: Comparison of one-step-ahead predictions for the long-stick angle and short-stick angle time series. The ground-truth trajectory is shown alongside model predictions for ESN, SVR, GPR, MLP, RF, EDMD, and LSTM. The NRMSE metric quantifies predictive accuracy. Kernel-based methods (GPR, SVR) and operator-theoretic EDMD demonstrate superior accuracy with minimal phase lag and reduced error near sharp nonlinear transitions, whereas recurrent (LSTM) and reservoir-based (ESN) models show larger deviations in highly nonlinear regions. Bottom row: Ablation study metrics for long- and short-stick time series.}
    \label{fig:appendix_combined_comparison}
\end{figure*}

            
% =====================================================
% LONG-STICK TABLES WITH FULL GRID + BOLD HEADER
% =====================================================
...
% ================= LONG STICK SUMMARY =================
        ...
        % %Hiten Start here
        % % SHORT STICK EVALutation TABLES
% =====================================================
% SHORT-STICK TABLES WITH FULL GRID + BOLD HEADER
% =====================================================

% \input{./short_stick_ablation_tables.tex}
